...
function onItemChange(index: number): void {
    ...
    if (Number(props.form.lines[index].cost_price) === 0) {
        props.form.lines[index].cost_price = selected.price;
    }
...
<template>
    <form class="space-y-6" @submit.prevent="emit('submit')">
        ...
        <div class="grid gap-4 md:grid-cols-3">
            <FormField name="order_date">
                <FormItem>
                    ...
                    <FormDescription>Data em que a encomenda fica fechada.</FormDescription>
                    <FormMessage>{{ form.errors.order_date }}</FormMessage>
                </FormItem>
            </FormField>
        ...
        <div class="space-y-3 rounded-md border p-4">
            ...
            <p class="text-sm font-medium">Valor total: {{ total.toFixed(2) }} EUR</p>
