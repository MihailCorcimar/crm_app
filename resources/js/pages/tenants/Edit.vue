...
const breadcrumbs: BreadcrumbItem[] = [
    ...
    { title: props.tenant.name, href: `/tenants/${props.tenant.slug}` },
    { title: 'Editar tenant', href: `/tenants/${props.tenant.slug}/edit` },
];
...
const form = useForm({
    ...
    settings: {
        brand_name: props.tenant.settings.brand_name,
        brand_primary_color: props.tenant.settings.brand_primary_color,
        default_user_role: props.tenant.settings.default_user_role,
        allow_member_invites: props.tenant.settings.allow_member_invites,
    },
});
...
function submit(): void {
    form.put(`/tenants/${props.tenant.slug}`);
}
                    ...
                    <form class="space-y-6" @submit.prevent="submit">
                        ...
                        <div class="flex gap-3">
                            ...
                            <Button type="button" variant="outline" as-child>
                                <Link :href="`/tenants/${tenant.slug}`">Cancelar</Link>
                            </Button>
                        </div>
                    </form>
                </CardContent>
